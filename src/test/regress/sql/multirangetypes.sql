...
SELECT * FROM nummultirange_test WHERE nmr < '{}';
SELECT * FROM nummultirange_test WHERE nmr < '{[-1000.0, -1000.0]}' ORDER BY nmr;
SELECT * FROM nummultirange_test WHERE nmr < '{[0.0, 1.0]}' ORDER BY nmr;
SELECT * FROM nummultirange_test WHERE nmr < '{[1000.0, 1001.0]}' ORDER BY nmr;
SELECT * FROM nummultirange_test WHERE nmr <= '{}';
SELECT * FROM nummultirange_test WHERE nmr <= '{[3,)}';
SELECT * FROM nummultirange_test WHERE nmr >= '{}' ORDER BY nmr;
SELECT * FROM nummultirange_test WHERE nmr >= '{[3,)}' ORDER BY nmr;
SELECT * FROM nummultirange_test WHERE nmr > '{}';
SELECT * FROM nummultirange_test WHERE nmr > '{[-1000.0, -1000.0]}';
SELECT * FROM nummultirange_test WHERE nmr > '{[0.0, 1.0]}' ORDER BY nmr;
SELECT * FROM nummultirange_test WHERE nmr > '{[1000.0, 1001.0]}' ORDER BY nmr;
SELECT * FROM nummultirange_test WHERE nmr <> '{}' ORDER BY nmr;
SELECT * FROM nummultirange_test WHERE nmr <> '{(,5)}' ORDER BY nmr;
