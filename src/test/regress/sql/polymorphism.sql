...
select f3, myaggp05a(f1) from (select * from t order by f1) as x group by f3 order by f3;
...
select f3, myaggp10a(f1) from (select * from t order by f1) as x group by f3 order by f3;
select f3, myaggp10b(f1) from (select * from t order by f1) as x group by f3 order by f3;
select f3, myaggp20a(f1) from (select * from t order by f1) as x group by f3 order by f3;
select f3, myaggp20b(f1) from (select * from t order by f1) as x group by f3 order by f3;
...
select f3, myaggn05a(f1) from (select * from t order by f1) as x group by f3 order by f3;
select f3, myaggn05b(f1) from (select * from t order by f1) as x group by f3 order by f3;
...
select f3, myaggn10a(f1) from (select * from t order by f1) as x group by f3 order by f3;
...
select f1, sql_if(f1 > 0, bleat(f1), bleat(f1 + 1)) from int4_tbl order by f1;

select q2, sql_if(q2 > 0, q2, q2 + 1) from int8_tbl order by q2;
...
select build_group(q1,3) from (select * from int8_tbl order by q1) as x;
...
select * from dfview order by q1,q2;
