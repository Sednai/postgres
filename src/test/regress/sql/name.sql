...
SELECT * FROM NAME_TBL ORDER BY f1;

SELECT c.f1 FROM NAME_TBL c WHERE c.f1 <> '1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890ABCDEFGHIJKLMNOPQR' ORDER BY f1;
...
SELECT c.f1 FROM NAME_TBL c WHERE c.f1 ~ '.*' ORDER BY f1;

SELECT c.f1 FROM NAME_TBL c WHERE c.f1 !~ '.*' ORDER BY f1;

SELECT c.f1 FROM NAME_TBL c WHERE c.f1 ~ '[0-9]' ORDER BY f1;

SELECT c.f1 FROM NAME_TBL c WHERE c.f1 ~ '.*asdf.*' ORDER BY f1;
