...
SELECT '' AS five, q1 AS plus, -q1 AS minus FROM INT8_TBL ORDER BY plus;

SELECT '' AS five, q1, q2, q1 + q2 AS plus FROM INT8_TBL ORDER BY q1,plus;
...
SELECT '' AS five, 2 * q1 AS "twice int4" FROM INT8_TBL ORDER BY "twice int4";
SELECT '' AS five, q1 * 2 AS "twice int4" FROM INT8_TBL ORDER BY "twice int4";
