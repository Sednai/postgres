...
SELECT * FROM FLOAT8_TBL ORDER BY f1;

SELECT f.* FROM FLOAT8_TBL f WHERE f.f1 <> '1004.3' ORDER BY f1;

SELECT f.* FROM FLOAT8_TBL f WHERE f.f1 = '1004.3';

SELECT f.* FROM FLOAT8_TBL f WHERE '1004.3' > f.f1 ORDER BY f1;
...
SELECT f.f1, ||/f.f1 AS cbrt_f1 FROM FLOAT8_TBL f ORDER BY f1;
...
SELECT exp(f.f1) from FLOAT8_TBL f order by f.f1 desc;
