...
SELECT * FROM FLOAT4_TBL ORDER BY f1;

SELECT f.* FROM FLOAT4_TBL f WHERE f.f1 <> '1004.3' ORDER BY f1;

SELECT f.* FROM FLOAT4_TBL f WHERE f.f1 = '1004.3';

SELECT f.* FROM FLOAT4_TBL f WHERE '1004.3' > f.f1 ORDER BY f1;
...
SELECT f.f1, @f.f1 AS abs_f1 FROM FLOAT4_TBL f ORDER BY f1;
