...
SELECT i.* FROM INT4_TBL i WHERE i.f1 <> int2 '0' ORDER BY f1;

SELECT i.* FROM INT4_TBL i WHERE i.f1 <> int4 '0' ORDER BY f1;
...
-- any evens
SELECT i.* FROM INT4_TBL i WHERE (i.f1 % int4 '2') = int2 '0' ORDER BY f1;
...
SELECT i.f1, i.f1 / int2 '2' AS x FROM INT4_TBL i ORDER BY f1;

SELECT i.f1, i.f1 / int4 '2' AS x FROM INT4_TBL i ORDER BY f1;
