...
/* PGXC_BEGIN */
	CONNECTION CONSTRAINT CONSTRAINTS CONTENT_P CONTINUE_P CONVERSION_P COORDINATOR COPY
/* PGXC_END */
...
/* PGXC_BEGIN */	
	DETACH DICTIONARY DIRECT DISABLE_P DISCARD DISTINCT DISTRIBUTE DO DOCUMENT_P DOMAIN_P
/* PGXC_END */
	DOUBLE_P DROP
...
CleanConnStmt: CLEAN CONNECTION TO COORDINATOR pgxcnodes CleanConnDbName CleanConnUserName
				...
				| CLEAN CONNECTION TO ALL CleanConnDbName CleanConnUserName
				{
					CleanConnStmt *n = makeNode(CleanConnStmt);
					n->is_coord = true;
					n->nodes = NIL;
