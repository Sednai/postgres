...
PG_CMDTAG(CMDTAG_ALTER_NODE, "ALTER NODE", true, false, false)
...
#ifdef PGXC
PG_CMDTAG(CMDTAG_CREATE_BARRIER, "CREATE BARRIER", true, false, false)
#endif
...
PG_CMDTAG(CMDTAG_CREATE_NODE, "CREATE NODE", true, false, false)
PG_CMDTAG(CMDTAG_CREATE_NODE_GROUP, "CREATE NODE GROUP", true, false, false)
...
PG_CMDTAG(CMDTAG_DROP_NODE, "DROP NODE", true, false, false)
PG_CMDTAG(CMDTAG_DROP_NODE_GROUP, "DROP NODE GROUP", true, false, false)
...
PG_CMDTAG(CMDTAG_EXECUTE_DIRECT, "EXECUTE DIRECT", false, false, false)
