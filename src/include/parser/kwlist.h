...
#ifdef PGXC
PG_KEYWORD("barrier", BARRIER, UNRESERVED_KEYWORD, AS_LABEL)
#endif
...
#ifdef PGXC
PG_KEYWORD("clean", CLEAN, UNRESERVED_KEYWORD, AS_LABEL)
#endif
...
#ifdef PGXC
PG_KEYWORD("direct", DIRECT, UNRESERVED_KEYWORD, AS_LABEL)
#endif
...
#ifdef PGXC
PG_KEYWORD("distribute", DISTRIBUTE, UNRESERVED_KEYWORD, AS_LABEL)
#endif
...
#ifdef PGXC
PG_KEYWORD("node", NODE, UNRESERVED_KEYWORD, AS_LABEL)
#endif
...
/* PGXC_BEGIN */
PG_KEYWORD("preferred", PREFERRED, UNRESERVED_KEYWORD, AS_LABEL)
/* PGXC_END */
